...
export function checkBuiltDocsCoreArtifacts(artifacts: BuiltDocsArtifacts) {
  ...
  add(
    ...
    includesAll(artifacts.docsSitemap, [
      ...
      "<loc>https://docs.amend.sh/docs/customer-surfaces</loc>",
      "<loc>https://docs.amend.sh/docs/source-events</loc>",
      "<loc>https://docs.amend.sh/docs/automation</loc>",
      "<loc>https://docs.amend.sh/docs/api-reference</loc>",
      "<loc>https://docs.amend.sh/docs/source-trace</loc>",
      "<loc>https://docs.amend.sh/docs/self-hosting</loc>",
      "<loc>https://docs.amend.sh/docs/production-routing</loc>",
