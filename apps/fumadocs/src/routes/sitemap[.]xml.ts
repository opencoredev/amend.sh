      ...
      GET: () => {
        const urlsByLoc = new Map(
          [
            ...
            { loc: `${docsUrl}/schemas/agent-ready-live-report.schema.json`, priority: "0.4" },
            { loc: `${docsUrl}/schemas/agent-ready-status-report.schema.json`, priority: "0.4" },
            {
