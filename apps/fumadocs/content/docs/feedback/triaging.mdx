...
The status pills sit in the sidebar and the toolbar. Changing a post's status here is the same status it carries everywhere else, including the roadmap.
...
<Screenshot caption="A request open in detail, with the Comments, Details, and Sources tabs." ratio="16 / 10" />
