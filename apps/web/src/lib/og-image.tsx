    ...
    <>
      <div
        style={{
          ...
          width: arm,
          height: arm,
          borderTop: `${w}px solid ${BRACKET}`,
          borderLeft: `${w}px solid ${BRACKET}`,
          display: "flex",
        }}
      />
      <div
        style={{
          ...
          height: arm,
          borderTop: `${w}px solid ${BRACKET}`,
          borderRight: `${w}px solid ${BRACKET}`,
          display: "flex",
        }}
      />
      <div
        style={{
          ...
          width: arm,
          height: arm,
          borderBottom: `${w}px solid ${BRACKET}`,
          borderLeft: `${w}px solid ${BRACKET}`,
          display: "flex",
        }}
      />
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <BrandMark />
          <span style={{ fontFamily: MONO_FONT, fontSize: 11, color: MUTED, letterSpacing: 0 }}>
            AMEND.SH
          </span>
        </div>
        ...
        >
          ...
          >
            Amend watches the places users talk, groups repeated demand, follows the work through
            GitHub and Linear, and updates the people who asked.
          </div>
        </div>
