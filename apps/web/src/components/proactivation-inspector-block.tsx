      ...
      <div className="mt-4 grid gap-2">
        {sourceLinks.slice(0, 3).map((link) => (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex min-h-9 items-center justify-between gap-3 rounded-md border border-border/70 bg-background/70 px-3 text-xs text-muted-foreground transition-[border-color,color,background-color] hover:border-foreground/35 hover:bg-muted/45 hover:text-foreground"
          >
