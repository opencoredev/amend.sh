...
import { ChevronDown, CircleDashed, Plus, Search } from "@/lib/icons";
...
export function DashboardHeader({
  ...
  // All status/column filtering now lives in per-page toolbars below the header.
  ...
  return (
    <header className="relative z-20 flex min-h-16 shrink-0 items-center justify-between gap-5 bg-background px-5 md:px-8">
